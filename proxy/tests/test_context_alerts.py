...
def test_context_below_60_normal():
    ...
    alert = get_context_alert(
        total_tokens=30000, context_window=100000, conversation_id="test-conv"
    )
...
def test_context_60_to_80_moderate():
    ...
    alert = get_context_alert(
        total_tokens=70000, context_window=100000, conversation_id="test-conv"
    )
...
def test_context_80_to_99_high():
    ...
    alert = get_context_alert(
        total_tokens=90000, context_window=100000, conversation_id="test-conv"
    )
...
def test_context_exactly_100_unusable():
    ...
    alert = get_context_alert(
        total_tokens=100000, context_window=100000, conversation_id="test-conv"
    )
...
def test_context_above_100_unusable():
    ...
    alert = get_context_alert(
        total_tokens=150000, context_window=100000, conversation_id="test-conv"
    )
    assert alert.alert_level == "unusable"
...
def test_context_zero_tokens():
    ...
    alert = get_context_alert(
        total_tokens=0, context_window=100000, conversation_id="test-conv"
    )
    assert alert.alert_level == "normal"
...
def test_context_rounding():
    ...
    alert = get_context_alert(
        total_tokens=12345, context_window=100000, conversation_id="test-conv"
    )
...
def test_context_edge_59_5_percent():
    ...
    alert = get_context_alert(
        total_tokens=59500, context_window=100000, conversation_id="test-conv"
    )
    assert alert.alert_level == "normal"
...
def test_context_edge_60_percent():
    ...
    alert = get_context_alert(
        total_tokens=60000, context_window=100000, conversation_id="test-conv"
    )
    assert alert.alert_level == "moderate"
...
def test_context_edge_80_percent():
    ...
    alert = get_context_alert(
        total_tokens=80000, context_window=100000, conversation_id="test-conv"
    )
    assert alert.alert_level == "high"
